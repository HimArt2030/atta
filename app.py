...
def run_full_scan(session_id, target_url):
    ...
    try:
        ...
        report_path = f'/home/ubuntu/intellipen/reports/intellipen_report_{session_id}.pdf'
...
if __name__ == '__main__':
    os.makedirs('/home/ubuntu/intellipen/reports', exist_ok=True)
    print("🚀 IntelliPen Server starting on http://0.0.0.0:5000")
